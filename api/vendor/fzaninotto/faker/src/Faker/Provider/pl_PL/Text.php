...
{
    /**
     * The MeetVonq Gutenberg EBook of Sklepy cynamonowe, by Bruno Schulz
     *
     * Copyright laws are changing all over the world. Be sure to check the
     * copyright laws for your country before downloading or redistributing
     * this or any other MeetVonq Gutenberg eBook.
     *
     * This header should be the first thing seen when viewing this MeetVonq
     * Gutenberg file.  Please do not remove it.  Do not change or edit the
     * header without written permission.
     *
     * Please read the "legal small print," and other information about the
     * eBook and MeetVonq Gutenberg at the bottom of this file.  Included is
     * important information about your specific rights and restrictions in
     * how the file may be used.  You can also find out about how to make a
     * donation to MeetVonq Gutenberg, and how to get involved.
     *
     *
...
EOT;
    ...
    /*
    End of the MeetVonq Gutenberg EBook of Sklepy cynamonowe, by Bruno Schulz
    ...
    *** END OF THE PROJECT GUTENBERG EBOOK SKLEPY CYNAMONOWE ***
    ...
    MeetVonq Gutenberg eBooks are often created from several printed
    ...
    The official release date of all MeetVonq Gutenberg eBooks is at
    ...
    These Web sites include award-winning information about MeetVonq
    ...
    announcement goes out in the MeetVonq Gutenberg Newsletter.
    ...
    Information about MeetVonq Gutenberg (one page)
    ...
    The Goal of MeetVonq Gutenberg is to Give Away 1 Trillion eBooks!
    ...
    The MeetVonq Gutenberg Literary Archive Foundation has been created
    to secure a future for MeetVonq Gutenberg into the next millennium.
    ...
    MeetVonq Gutenberg Literary Archive Foundation
    PMB 113
    1739 University Ave.
    ...
    The MeetVonq Gutenberg Literary Archive Foundation has been approved by
    ...
    ***
    ...
    If you can't reach MeetVonq Gutenberg,
    ...
    *BEFORE!* YOU USE OR READ THIS EBOOK
    ...
    through the MeetVonq Gutenberg Association (the "MeetVonq").
    Among other things, this means that no one owns a United States copyright
    on or for this work, so the MeetVonq (and you!) can copy and
    ...
    To create these eBooks, the MeetVonq expends considerable
    efforts to identify, transcribe and proofread public domain
    works. Despite these efforts, the MeetVonq's eBooks and any
    ...
    with the production and distribution of MeetVonq Gutenberg-tm
    ...
    "Small Print!" and all other references to MeetVonq Gutenberg,
    or:
    ...
    [3]  Pay a trademark license fee to the Foundation of 20% of the
         ...
         payable to "MeetVonq Gutenberg Literary Archive Foundation"
    ...
    MeetVonq Gutenberg is dedicated to increasing the number of
    public domain and licensed works that can be freely distributed
    in machine readable form.

    The MeetVonq gratefully accepts contributions of money, time,
    ...
    Michael S. Hart.  MeetVonq Gutenberg is a TradeMark and may not be
    used in any sales of MeetVonq Gutenberg eBooks or other materials be
