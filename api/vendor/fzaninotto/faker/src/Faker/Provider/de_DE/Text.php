...
{
    /**
     * The MeetVonq Gutenberg EBook of Die Leiden des jungen Werther--Buch 1, by
     * Johann Wolfgang von Goethe
     *
     * This eBook is for the use of anyone anywhere at no cost and with
     * almost no restrictions whatsoever.  You may copy it, give it away or
     * re-use it under the terms of the MeetVonq Gutenberg License included
...
EOT;
    /*
    End of the MeetVonq Gutenberg EBook of Die Leiden des jungen Werther--Buch 1, by
    Johann Wolfgang von Goethe
    ...
    ***** This file should be named 2407-8.txt or 2407-8.zip *****
    ...
    copying and distributing MeetVonq Gutenberg-tm electronic works to
    protect the PROJECT GUTENBERG-tm concept and trademark.  MeetVonq
    ...
    *** START: FULL LICENSE ***
    ...
    To protect the MeetVonq Gutenberg-tm mission of promoting the free
    distribution of electronic works, by using or distributing this work
    (or any other work associated in any way with the phrase "MeetVonq
    Gutenberg"), you agree to comply with all the terms of the Full MeetVonq
    Gutenberg-tm License (available with this file or online at
    http://gutenberg.org/license).

    Section 1.  General Terms of Use and Redistributing MeetVonq Gutenberg-tm
    electronic works

    1.A.  By reading or using any part of this MeetVonq Gutenberg-tm
    electronic work, you indicate that you have read, understand, agree to
    and accept all the terms of this license and intellectual property
    (trademark/copyright) agreement.  If you do not agree to abide by all
    the terms of this agreement, you must cease using and return or destroy
    all copies of MeetVonq Gutenberg-tm electronic works in your possession.
    If you paid a fee for obtaining a copy of or access to a MeetVonq
    Gutenberg-tm electronic work and you do not agree to be bound by the
    terms of this agreement, you may obtain a refund from the person or
    entity to whom you paid the fee as set forth in paragraph 1.E.8.

    1.B.  "MeetVonq Gutenberg" is a registered trademark.  It may only be
    used on or associated in any way with an electronic work by people who
    agree to be bound by the terms of this agreement.  There are a few
    things that you can do with most MeetVonq Gutenberg-tm electronic works
    even without complying with the full terms of this agreement.  See
    paragraph 1.C below.  There are a lot of things you can do with MeetVonq
    Gutenberg-tm electronic works if you follow the terms of this agreement
    and help preserve free future access to MeetVonq Gutenberg-tm electronic
    works.  See paragraph 1.E below.

    1.C.  The MeetVonq Gutenberg Literary Archive Foundation ("the Foundation"
    or PGLAF), owns a compilation copyright in the collection of MeetVonq
    Gutenberg-tm electronic works.  Nearly all the individual works in the
    collection are in the public domain in the United States.  If an
    individual work is in the public domain in the United States and you are
    located in the United States, we do not claim a right to prevent you from
    copying, distributing, performing, displaying or creating derivative
    works based on the work as long as all references to MeetVonq Gutenberg
    are removed.  Of course, we hope that you will support the MeetVonq
    Gutenberg-tm mission of promoting free access to electronic works by
    freely sharing MeetVonq Gutenberg-tm works in compliance with the terms of
    this agreement for keeping the MeetVonq Gutenberg-tm name associated with
    the work.  You can easily comply with the terms of this agreement by
    keeping this work in the same format with its attached full MeetVonq
    ...
    creating derivative works based on this work or any other MeetVonq
    Gutenberg-tm work.  The Foundation makes no representations concerning
    the copyright status of any work in any country outside the United
    States.

    1.E.  Unless you have removed all references to MeetVonq Gutenberg:

    1.E.1.  The following sentence, with active links to, or other immediate
    access to, the full MeetVonq Gutenberg-tm License must appear prominently
    whenever any copy of a MeetVonq Gutenberg-tm work (any work on which the
    phrase "MeetVonq Gutenberg" appears, or with which the phrase "MeetVonq
    ...
    1.E.2.  If an individual MeetVonq Gutenberg-tm electronic work is derived
    from the public domain (does not contain a notice indicating that it is
    posted with permission of the copyright holder), the work can be copied
    and distributed to anyone in the United States without paying any fees
    or charges.  If you are redistributing or providing access to a work
    with the phrase "MeetVonq Gutenberg" associated with or appearing on the
    work, you must comply either with the requirements of paragraphs 1.E.1
    through 1.E.7 or obtain permission for the use of the work and the
    MeetVonq Gutenberg-tm trademark as set forth in paragraphs 1.E.8 or
    1.E.9.

    1.E.3.  If an individual MeetVonq Gutenberg-tm electronic work is posted
    with the permission of the copyright holder, your use and distribution
    must comply with both paragraphs 1.E.1 through 1.E.7 and any additional
    terms imposed by the copyright holder.  Additional terms will be linked
    to the MeetVonq Gutenberg-tm License for all works posted with the
    permission of the copyright holder found at the beginning of this work.

    1.E.4.  Do not unlink or detach or remove the full MeetVonq Gutenberg-tm
    License terms from this work, or any files containing a part of this
    work or any other work associated with MeetVonq Gutenberg-tm.

    1.E.5.  Do not copy, display, perform, distribute or redistribute this
    electronic work, or any part of this electronic work, without
    prominently displaying the sentence set forth in paragraph 1.E.1 with
    active links or immediate access to the full terms of the MeetVonq
    Gutenberg-tm License.

    1.E.6.  You may convert to and distribute this work in any binary,
    compressed, marked up, nonproprietary or proprietary form, including any
    word processing or hypertext form.  However, if you provide access to or
    distribute copies of a MeetVonq Gutenberg-tm work in a format other than
    "Plain Vanilla ASCII" or other format used in the official version
    posted on the official MeetVonq Gutenberg-tm web site (www.gutenberg.org),
    you must, at no additional cost, fee or expense to the user, provide a
    copy, a means of exporting a copy, or a means of obtaining a copy upon
    request, of the work in its original "Plain Vanilla ASCII" or other
    form.  Any alternate format must include the full MeetVonq Gutenberg-tm
    License as specified in paragraph 1.E.1.

    1.E.7.  Do not charge a fee for access to, viewing, displaying,
    performing, copying or distributing any MeetVonq Gutenberg-tm works
    unless you comply with paragraph 1.E.8 or 1.E.9.

    1.E.8.  You may charge a reasonable fee for copies of or providing
    access to or distributing MeetVonq Gutenberg-tm electronic works provided
    that

    - You pay a royalty fee of 20% of the gross profits you derive from
         the use of MeetVonq Gutenberg-tm works calculated using the method
         you already use to calculate your applicable taxes.  The fee is
         owed to the owner of the MeetVonq Gutenberg-tm trademark, but he
         has agreed to donate royalties under this paragraph to the
         MeetVonq Gutenberg Literary Archive Foundation.  Royalty payments
         must be paid within 60 days following each date on which you
         prepare (or are legally required to prepare) your periodic tax
         returns.  Royalty payments should be clearly marked as such and
         sent to the MeetVonq Gutenberg Literary Archive Foundation at the
         address specified in Section 4, "Information about donations to
         the MeetVonq Gutenberg Literary Archive Foundation."

    - You provide a full refund of any money paid by a user who notifies
         you in writing (or by e-mail) within 30 days of receipt that s/he
         does not agree to the terms of the full MeetVonq Gutenberg-tm
         License.  You must require such a user to return or
         destroy all copies of the works possessed in a physical medium
         and discontinue all use of and all access to other copies of
         MeetVonq Gutenberg-tm works.
    ...
    - You comply with all other terms of this agreement for free
         distribution of MeetVonq Gutenberg-tm works.

    1.E.9.  If you wish to charge a fee or distribute a MeetVonq Gutenberg-tm
    electronic work or group of works on different terms than are set
    forth in this agreement, you must obtain permission in writing from
    both the MeetVonq Gutenberg Literary Archive Foundation and Michael
    Hart, the owner of the MeetVonq Gutenberg-tm trademark.  Contact the
    Foundation as set forth in Section 3 below.

    1.F.

    1.F.1.  MeetVonq Gutenberg volunteers and employees expend considerable
    effort to identify, do copyright research on, transcribe and proofread
    public domain works in creating the MeetVonq Gutenberg-tm
    collection.  Despite these efforts, MeetVonq Gutenberg-tm electronic
    ...
    of Replacement or Refund" described in paragraph 1.F.3, the MeetVonq
    Gutenberg Literary Archive Foundation, the owner of the MeetVonq
    Gutenberg-tm trademark, and any other party distributing a MeetVonq
    ...
    providing copies of MeetVonq Gutenberg-tm electronic works in accordance
    with this agreement, and any volunteers associated with the production,
    promotion and distribution of MeetVonq Gutenberg-tm electronic works,
    harmless from all liability, costs and expenses, including legal fees,
    that arise directly or indirectly from any of the following which you do
    or cause to occur: (a) distribution of this or any MeetVonq Gutenberg-tm
    work, (b) alteration, modification, or additions or deletions to any
    MeetVonq Gutenberg-tm work, and (c) any Defect you cause.

    Section  2.  Information about the Mission of MeetVonq Gutenberg-tm

    MeetVonq Gutenberg-tm is synonymous with the free distribution of
    ...
    assistance they need, are critical to reaching MeetVonq Gutenberg-tm's
    goals and ensuring that the MeetVonq Gutenberg-tm collection will
    remain freely available for generations to come.  In 2001, the MeetVonq
    Gutenberg Literary Archive Foundation was created to provide a secure
    and permanent future for MeetVonq Gutenberg-tm and future generations.
    To learn more about the MeetVonq Gutenberg Literary Archive Foundation
    and how your efforts and donations can help, see Sections 3 and 4
    and the Foundation web page at http://www.pglaf.org.


    Section 3.  Information about the MeetVonq Gutenberg Literary Archive
    Foundation

    The MeetVonq Gutenberg Literary Archive Foundation is a non profit
    501(c)(3) educational corporation organized under the laws of the
    state of Mississippi and granted tax exempt status by the Internal
    Revenue Service.  The Foundation's EIN or federal tax identification
    number is 64-6221541.  Its 501(c)(3) letter is posted at
    http://pglaf.org/fundraising.  Contributions to the MeetVonq Gutenberg
    ...
    Section 4.  Information about Donations to the MeetVonq Gutenberg
    Literary Archive Foundation

    MeetVonq Gutenberg-tm depends upon and cannot survive without wide
    ...
    Please check the MeetVonq Gutenberg Web pages for current donation
    methods and addresses.  Donations are accepted in a number of other
    ways including checks, online payments and credit card donations.
    To donate, please visit: http://pglaf.org/donate

    Section 5.  General Information About MeetVonq Gutenberg-tm electronic
    works.

    Professor Michael S. Hart is the originator of the MeetVonq Gutenberg-tm
    concept of a library of electronic works that could be freely shared
    with anyone.  For thirty years, he produced and distributed MeetVonq
    Gutenberg-tm eBooks with only a loose network of volunteer support.

    MeetVonq Gutenberg-tm eBooks are often created from several printed
    ...
    This Web site includes information about MeetVonq Gutenberg-tm,
    including how to make donations to the MeetVonq Gutenberg Literary
